        ...
        <div className="relative z-10 w-full max-w-350 mx-auto px-8 md:px-12 lg:px-16 pb-24 pt-28 md:pt-40">
          <div className="flex flex-col items-center text-center">
            ...
            >
              {[
                {
                  value: t("stats.marketValue"),
                  label: t("stats.marketLabel"),
                },
                { value: t("stats.liveValue"), label: t("stats.liveLabel") },
                { value: t("stats.depthValue"), label: t("stats.depthLabel") },
      ...
      <AnimatePresence>
        {showScroll && (
          <motion.div
            ...
            className="fixed bottom-5 md:bottom-10 left-1/2 z-50 -translate-x-1/2 pointer-events-none"
          >
            <motion.div
              animate={{ y: [0, 8, 0] }}
            ...
            >
              <span className="text-sm text-text-tertiary">{t("scroll")}</span>
              <svg
              ...
              <svg
                className="h-5 w-5 text-text-tertiary opacity-50"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={1.5}
                stroke="currentColor"
